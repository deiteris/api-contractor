...
* AML Language Server updated to [6.0.5](https://github.com/aml-org/als/releases/tag/v6.0.5).

## 2.1.24

* AML Language Server updated to [5.4.1-0](https://github.com/aml-org/als/releases/tag/v5.4.1-0).

## 2.1.23

* AML Language Server updated to [5.3.8](https://github.com/aml-org/als/releases/tag/v5.3.8).

## 2.1.22

* AML Language Server updated to [5.3.5](https://github.com/aml-org/als/releases/tag/v5.3.5).

## 2.1.21

* AML Language Server updated to [5.3.4](https://github.com/aml-org/als/releases/tag/v5.3.4).

## 2.1.20

* AML Language Server updated to [5.3.2](https://github.com/aml-org/als/releases/tag/v5.3.2).

## 2.1.18

* AML Language Server updated to [5.3.0](https://github.com/aml-org/als/releases/tag/v5.3.0).
...
* AML Language Server updated to [5.1.7](https://github.com/aml-org/als/releases/tag/v5.1.7).
